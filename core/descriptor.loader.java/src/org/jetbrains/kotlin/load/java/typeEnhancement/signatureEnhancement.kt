...
class SignatureEnhancement(private val annotationTypeQualifierResolver: AnnotationTypeQualifierResolver) {
    ...
    private fun <D : CallableMemberDescriptor> D.enhanceSignature(c: LazyJavaResolverContext): D {
        ...
        val valueParameterEnhancements = enhanceValueParameters(
    ...
    private fun <D : CallableMemberDescriptor> D.enhanceValueParameters(
            valueParameters: List<ValueParameterDescriptor>,
            outerScopeQualifiers: JavaTypeQualifiersByElementType?,
            predefinedEnhancementInfo: PredefinedFunctionEnhancementInfo?
    ): List<ValueParameterEnhancementResult> = valueParameters.map { parameter ->
        ...
        val hasDefaultValue = when (defaultValue) {
            ...
            null -> parameter.declaresDefaultValue()
        } && parameter.overriddenDescriptors.isEmpty()
